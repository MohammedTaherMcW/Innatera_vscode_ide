...
* Configure custom buttons and commands in PlatformIO Toolbar with a new `Innatera-snp-ide.toolbar` configuration option (issue [#1697](https://github.com/platformio/platformio-vscode-ide/issues/1697))
...
* Fixed an issue with "'Innatera-snp-ide.build' not found" (issue [#1398](https://github.com/platformio/platformio-vscode-ide/issues/1398))
